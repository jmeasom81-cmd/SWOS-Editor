...
const publication={
  ...
  mode:'authoritative-source-to-static-dist-finalizer',
  resources,
  safety:{teamWriteReady:false,careerWriteReady:false,note:'Static publication never enables TEAM.* or .CAR writes.'}
};
